...
final class FoursquareClient: APIClient {
    ...
    func fetchRestaurantsFor(location: Coordinate, category: Foursquare.VenueEndpoint.Category = Foursquare.VenueEndpoint.Category.Food(nil), query: String? = nil, searchRadius: Int? = nil, limit: Int? = nil, completion: APIResult<[Venue]> -> Void) {
        ...
        fetch(endpoint, parse: { json -> [Venue]? in
            ...
            guard let venues = json["response"]?["venues"] as? [JSON] else {
                return nil
            }
